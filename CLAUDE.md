...
|--------|---------|---------|
| dev-flow | 6.0.0 | Development workflow: brainstorm → plan → implement (5-gate pipeline) → commit → PR → release + automated code review (P0-P3) + agent-team + cross-platform team + 4-tier memory with instinct system + Notion pipeline + product brain + rules distribution |
...
| `continuity/` | Ledgers, reasoning, task-sync, memory, instincts, product-brain, context-injector |
