---
name: evaluate-agent
description: Evaluation agent that analyzes session performance and identifies improvement targets. Triggers on "evaluate recent sessions", "analyze agent performance", "评估会话质量", "分析性能". Do NOT use directly — spawned by meta-iterate skill.
model: sonnet
memory: user
color: blue
---
